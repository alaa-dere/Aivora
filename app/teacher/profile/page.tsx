    ...
    <div className="min-h-screen bg-transparent p-4 md:p-6 transition-colors duration-300">
      <div className="mb-5">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
          Overview, contact details, and security settings in one place.
        </p>
      </div>
              ...
              <div className="relative overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 p-5 pt-7 bg-white dark:bg-slate-900/70 shadow-sm h-full min-h-[560px]">
                ...
                <div className="flex flex-col items-center text-center mb-6 mt-2">
                  <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-green-50 to-blue-50 dark:from-white/10 dark:to-white/10 border border-green-100 dark:border-white/20 flex items-center justify-center overflow-hidden">
                    {profile.imageUrl ? (
                      <img src={profile.imageUrl} alt={profile.fullName || 'Teacher'} className="h-full w-full rounded-2xl object-cover" />
                    ) : (
                  ...
                  <div className="mt-3">
                    ...
                    <p className="text-[15px] text-slate-500 dark:text-slate-400 inline-flex items-center gap-1.5 mt-1">
                      <span className="inline-flex h-4 w-4 items-center justify-center rounded-full bg-blue-50 text-blue-700 dark:bg-blue-900/40 dark:text-blue-200 text-[10px] font-bold">@</span>
                      {profile.email}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 space-y-3 text-sm">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-slate-700 dark:text-slate-200">{formatDate(profile.createdAt)}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500 dark:text-slate-400">Last Updated</span>
                    <span className="font-medium text-slate-700 dark:text-slate-200">{formatDate(profile.updatedAt)}</span>
                  </div>
                </div>
              </div>
            </aside>
