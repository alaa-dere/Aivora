...
export const ROLE_FEATURES = {
  student: [
    ...
    {
      id: 'student-my-course-player',
      title: 'My Course Player',
      endpoint: API_ROUTES.student.myCourseContentTemplate,
      params: ['courseId'],
    },
  ...
  teacher: [
    ...
    { id: 'teacher-students', title: 'Students', endpoint: API_ROUTES.teacher.courses },
    {
      id: 'teacher-question-bank',
      title: 'Quizzes / Question Bank',
      endpoint: `${API_ROUTES.teacher.questionBank}?courseId=:courseId`,
      params: ['courseId'],
    },
    ...
    { id: 'teacher-earnings', title: 'Earnings', endpoint: '/api/teachers' },
