-- MySQL dump 10.13  Distrib 8.0.45, for Win64 (x86_64)਍ഀ
--਍ഀ
-- Host: localhost    Database: aivora_db਍ഀ
-- ------------------------------------------------------਍ഀ
-- Server version	8.0.45਍ഀ
਍ഀ
...
/*!40000 ALTER TABLE `admin_teacher_thread` ENABLE KEYS */;਍ഀ
UNLOCK TABLES;਍ഀ
਍ഀ
--਍ഀ
-- Table structure for table `certificate`਍ഀ
--਍ഀ
਍ഀ
DROP TABLE IF EXISTS `certificate`;਍ഀ
/*!40101 SET @saved_cs_client     = @@character_set_client */;਍ഀ
/*!50503 SET character_set_client = utf8mb4 */;਍ഀ
CREATE TABLE `certificate` (਍ഀ
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `studentId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `courseId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `certificateNo` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `issuedAt` datetime DEFAULT CURRENT_TIMESTAMP,਍ഀ
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP,਍ഀ
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,਍ഀ
  PRIMARY KEY (`id`),਍ഀ
  UNIQUE KEY `unique_student_course` (`studentId`,`courseId`),਍ഀ
  UNIQUE KEY `unique_certificate_no` (`certificateNo`),਍ഀ
  KEY `idx_studentId` (`studentId`),਍ഀ
  KEY `idx_courseId` (`courseId`),਍ഀ
  CONSTRAINT `certificate_ibfk_1` FOREIGN KEY (`studentId`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,਍ഀ
  CONSTRAINT `certificate_ibfk_2` FOREIGN KEY (`courseId`) REFERENCES `course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE਍ഀ
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;਍ഀ
/*!40101 SET character_set_client = @saved_cs_client */;਍ഀ
਍ഀ
--਍ഀ
-- Dumping data for table `certificate`਍ഀ
--਍ഀ
਍ഀ
LOCK TABLES `certificate` WRITE;਍ഀ
/*!40000 ALTER TABLE `certificate` DISABLE KEYS */;਍ഀ
INSERT INTO `certificate` VALUES ('12abda36-a7f3-4cd4-98b8-c58a54e0161d','820b3b3c-2c26-11f1-97b2-6c02e0d26821','4f0dd6ed-2076-11f1-97b2-6c02e0d26821','AIV-PP-20260330-12ABDA','2026-03-30 15:42:49','2026-03-30 15:42:49','2026-03-30 15:42:49'),('57fe6bab-38cb-4863-a562-ffef4b3b1599','437c1b23-1bab-11f1-97b2-6c02e0d26821','4f0dd6ed-2076-11f1-97b2-6c02e0d26821','AIV-PP-20260331-57FE6B','2026-03-31 20:26:47','2026-03-31 20:26:47','2026-03-31 20:26:47'),('727e81f5-8825-4e3a-8555-e2d86a0926f1','e0183a49-2d4f-11f1-97b2-6c02e0d26821','4f0dd6ed-2076-11f1-97b2-6c02e0d26821','AIV-PP-20260331-727E81','2026-04-01 01:23:35','2026-04-01 01:23:35','2026-04-01 01:23:35'),('7df61932-c269-493c-a8d1-ae21f50a2b0b','fcaa82e7-2ad0-11f1-97b2-6c02e0d26821','4f0dd6ed-2076-11f1-97b2-6c02e0d26821','AIV-PP-20260330-7DF619','2026-03-30 14:01:31','2026-03-30 14:01:31','2026-03-30 14:01:31'),('91ff8d22-f9ab-4a7a-92b5-5457d16d2a84','598cdd8a-2d2d-11f1-97b2-6c02e0d26821','4f0dd6ed-2076-11f1-97b2-6c02e0d26821','AIV-PP-20260331-91FF8D','2026-03-31 21:15:04','2026-03-31 21:15:04','2026-03-31 21:15:04'),('96504f5f-43da-49be-939e-839208500769','47c1d5ab-2d46-11f1-97b2-6c02e0d26821','4f0dd6ed-2076-11f1-97b2-6c02e0d26821','AIV-PP-20260331-96504F','2026-04-01 01:16:50','2026-04-01 01:16:50','2026-04-01 01:16:50'),('a46756a6-29fb-11f1-97b2-6c02e0d26821','57967169-2842-11f1-97b2-6c02e0d26821','4f0dd6ed-2076-11f1-97b2-6c02e0d26821','AIV-PP-20260327-A46756','2026-03-27 18:40:19','2026-03-27 18:40:19','2026-03-27 18:40:19');਍ഀ
/*!40000 ALTER TABLE `certificate` ENABLE KEYS */;਍ഀ
UNLOCK TABLES;਍ഀ
਍ഀ
--਍ഀ
-- Table structure for table `chat_conversation`਍ഀ
--਍ഀ
਍ഀ
DROP TABLE IF EXISTS `chat_conversation`;਍ഀ
/*!40101 SET @saved_cs_client     = @@character_set_client */;਍ഀ
/*!50503 SET character_set_client = utf8mb4 */;਍ഀ
CREATE TABLE `chat_conversation` (਍ഀ
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `courseId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `studentId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `teacherId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  ...
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,਍ഀ
  PRIMARY KEY (`id`),਍ഀ
  UNIQUE KEY `unique_course_student_teacher` (`courseId`,`studentId`,`teacherId`),਍ഀ
  KEY `idx_studentId` (`studentId`),਍ഀ
  KEY `idx_teacherId` (`teacherId`),਍ഀ
  KEY `idx_courseId` (`courseId`),਍ഀ
  CONSTRAINT `chat_conversation_ibfk_1` FOREIGN KEY (`courseId`) REFERENCES `course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,਍ഀ
  CONSTRAINT `chat_conversation_ibfk_2` FOREIGN KEY (`studentId`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,਍ഀ
  CONSTRAINT `chat_conversation_ibfk_3` FOREIGN KEY (`teacherId`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE਍ഀ
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;਍ഀ
/*!40101 SET character_set_client = @saved_cs_client */;਍ഀ
਍ഀ
--਍ഀ
-- Dumping data for table `chat_conversation`਍ഀ
--਍ഀ
਍ഀ
LOCK TABLES `chat_conversation` WRITE;਍ഀ
/*!40000 ALTER TABLE `chat_conversation` DISABLE KEYS */;਍ഀ
...
/*!40000 ALTER TABLE `chat_conversation` ENABLE KEYS */;਍ഀ
UNLOCK TABLES;਍ഀ
਍ഀ
--਍ഀ
-- Table structure for table `chat_message`਍ഀ
--਍ഀ
਍ഀ
DROP TABLE IF EXISTS `chat_message`;਍ഀ
/*!40101 SET @saved_cs_client     = @@character_set_client */;਍ഀ
/*!50503 SET character_set_client = utf8mb4 */;਍ഀ
CREATE TABLE `chat_message` (਍ഀ
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `conversationId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `senderId` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `senderRole` enum('student','teacher') COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `body` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP,਍ഀ
  `readAt` datetime DEFAULT NULL,਍ഀ
  `deletedForStudentAt` datetime DEFAULT NULL,਍ഀ
  `deletedForTeacherAt` datetime DEFAULT NULL,਍ഀ
  `deletedForEveryoneAt` datetime DEFAULT NULL,਍ഀ
  PRIMARY KEY (`id`),਍ഀ
  KEY `idx_conversationId` (`conversationId`),਍ഀ
  KEY `idx_createdAt` (`createdAt`),਍ഀ
  KEY `idx_senderId` (`senderId`),਍ഀ
  KEY `idx_readAt` (`readAt`),਍ഀ
  KEY `idx_chat_deleted_everyone` (`deletedForEveryoneAt`),਍ഀ
  KEY `idx_chat_deleted_student` (`deletedForStudentAt`),਍ഀ
  KEY `idx_chat_deleted_teacher` (`deletedForTeacherAt`),਍ഀ
  CONSTRAINT `chat_message_ibfk_1` FOREIGN KEY (`conversationId`) REFERENCES `chat_conversation` (`id`) ON DELETE CASCADE ON UPDATE CASCADE਍ഀ
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;਍ഀ
/*!40101 SET character_set_client = @saved_cs_client */;਍ഀ
਍ഀ
--਍ഀ
-- Dumping data for table `chat_message`਍ഀ
--਍ഀ
਍ഀ
LOCK TABLES `chat_message` WRITE;਍ഀ
/*!40000 ALTER TABLE `chat_message` DISABLE KEYS */;਍ഀ
INSERT INTO `chat_message` VALUES ('190882d6-2acc-11f1-97b2-6c02e0d26821','26e74541-2ac1-11f1-97b2-6c02e0d26821','ceb02830-1a95-11f1-97b2-6c02e0d26821','student','hi','2026-03-28 20:32:30','2026-03-29 19:56:05',NULL,NULL,NULL),('1eeebfec-2acc-11f1-97b2-6c02e0d26821','26e74541-2ac1-11f1-97b2-6c02e0d26821','ceb02830-1a95-11f1-97b2-6c02e0d26821','student','helloooooooooowwwwwwwwwwwww','2026-03-28 20:32:40','2026-03-29 19:56:05',NULL,NULL,NULL),('2fefa71e-2ac1-11f1-97b2-6c02e0d26821','26e74541-2ac1-11f1-97b2-6c02e0d26821','ceb02830-1a95-11f1-97b2-6c02e0d26821','student','hello teacher','2026-03-28 19:14:24','2026-03-29 19:56:05',NULL,NULL,NULL),('4d56a1e6-2bbe-11f1-97b2-6c02e0d26821','ba8cb338-2b9a-11f1-97b2-6c02e0d26821','f74bdb60-2acf-11f1-97b2-6c02e0d26821','student','hi','2026-03-30 01:26:16','2026-03-31 20:13:01',NULL,NULL,NULL),('5f39d0d3-2abf-11f1-97b2-6c02e0d26821','5752e01e-2abf-11f1-97b2-6c02e0d26821','955acab2-18fd-11f1-97b2-6c02e0d26821','student','hi teacher','2026-03-28 19:01:24','2026-03-29 20:22:26',NULL,NULL,NULL),('820aa38f-2acc-11f1-97b2-6c02e0d26821','78b36abc-2acc-11f1-97b2-6c02e0d26821','c8e9f78f-2a8d-11f1-97b2-6c02e0d26821','student','i want to ask a question','2026-03-28 20:35:26','2026-03-29 20:33:30',NULL,NULL,NULL),('b5dcb073-2b99-11f1-97b2-6c02e0d26821','b33082ec-2b99-11f1-97b2-6c02e0d26821','f1779632-1905-11f1-97b2-6c02e0d26821','teacher','hi','2026-03-29 21:04:20',NULL,NULL,NULL,NULL),('be1935c1-2b9a-11f1-97b2-6c02e0d26821','ba8cb338-2b9a-11f1-97b2-6c02e0d26821','f1779632-1905-11f1-97b2-6c02e0d26821','teacher','hi meme','2026-03-29 21:11:43',NULL,NULL,NULL,NULL);਍ഀ
/*!40000 ALTER TABLE `chat_message` ENABLE KEYS */;਍ഀ
UNLOCK TABLES;਍ഀ
਍ഀ
--਍ഀ
-- Table structure for table `course`਍ഀ
--਍ഀ
਍ഀ
DROP TABLE IF EXISTS `course`;਍ഀ
/*!40101 SET @saved_cs_client     = @@character_set_client */;਍ഀ
/*!50503 SET character_set_client = utf8mb4 */;਍ഀ
CREATE TABLE `course` (਍ഀ
  `id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `descriptionAr` text COLLATE utf8mb4_unicode_ci,਍ഀ
  `teacherId` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `price` decimal(10,2) DEFAULT '0.00',਍ഀ
  `teacherSharePct` int DEFAULT '60',਍ഀ
  `status` enum('draft','published','archived') COLLATE utf8mb4_unicode_ci DEFAULT 'draft',਍ഀ
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP,਍ഀ
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,਍ഀ
  `imageUrl` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,਍ഀ
  `durationWeeks` int DEFAULT '0',਍ഀ
  PRIMARY KEY (`id`),਍ഀ
  KEY `idx_teacherId` (`teacherId`),਍ഀ
  CONSTRAINT `course_ibfk_1` FOREIGN KEY (`teacherId`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE਍ഀ
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;਍ഀ
/*!40101 SET character_set_client = @saved_cs_client */;਍ഀ
਍ഀ
--਍ഀ
-- Dumping data for table `course`਍ഀ
--਍ഀ
਍ഀ
LOCK TABLES `course` WRITE;਍ഀ
/*!40000 ALTER TABLE `course` DISABLE KEYS */;਍ഀ
...
CREATE TABLE `module` (਍ഀ
  ...
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,਍ഀ
  PRIMARY KEY (`id`),਍ഀ
  UNIQUE KEY `unique_order` (`courseId`,`orderNumber`),਍ഀ
  CONSTRAINT `module_ibfk_1` FOREIGN KEY (`courseId`) REFERENCES `course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE਍ഀ
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;਍ഀ
/*!40101 SET character_set_client = @saved_cs_client */;਍ഀ
਍ഀ
--਍ഀ
-- Dumping data for table `module`਍ഀ
--਍ഀ
਍ഀ
LOCK TABLES `module` WRITE;਍ഀ
/*!40000 ALTER TABLE `module` DISABLE KEYS */;਍ഀ
INSERT INTO `module` VALUES ('603620ee-20b0-11f1-97b2-6c02e0d26821','4f0dd6ed-2076-11f1-97b2-6c02e0d26821','Python Basics','-Python Syntax and Indentation\n-Variables and Data Types\n-Numbers and Mathematical Operations\n-Strings and String Manipulation\n-Comments and Code Readability\n-Input and Output in Python',2,'2026-03-15 22:48:52','2026-03-15 22:48:52'),('7c0ea9ec-2079-11f1-97b2-6c02e0d26821','4f0dd6ed-2076-11f1-97b2-6c02e0d26821','Introduction to Python','-What is Python?\n-History and Features of Python\n-Installing Python and Setting Up the Environment\n-Writing Your First Python Program\n-Understanding the Python Interpreter\n-Python IDEs (VS Code, PyCharm, Jupyter)',1,'2026-03-15 16:15:56','2026-03-15 21:55:53'),('a2e67e29-2840-11f1-97b2-6c02e0d26821','8398c88d-2840-11f1-97b2-6c02e0d26821','chapter 1',NULL,1,'2026-03-25 13:49:10','2026-03-25 13:49:10');਍ഀ
/*!40000 ALTER TABLE `module` ENABLE KEYS */;਍ഀ
UNLOCK TABLES;਍ഀ
਍ഀ
--਍ഀ
-- Table structure for table `passwordresettoken`਍ഀ
--਍ഀ
਍ഀ
DROP TABLE IF EXISTS `passwordresettoken`;਍ഀ
/*!40101 SET @saved_cs_client     = @@character_set_client */;਍ഀ
/*!50503 SET character_set_client = utf8mb4 */;਍ഀ
CREATE TABLE `passwordresettoken` (਍ഀ
  `id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `userId` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `token` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `expiresAt` datetime NOT NULL,਍ഀ
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP,਍ഀ
  PRIMARY KEY (`id`),਍ഀ
  UNIQUE KEY `token` (`token`),਍ഀ
  KEY `userId` (`userId`),਍ഀ
  CONSTRAINT `passwordresettoken_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE਍ഀ
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;਍ഀ
/*!40101 SET character_set_client = @saved_cs_client */;਍ഀ
਍ഀ
--਍ഀ
-- Dumping data for table `passwordresettoken`਍ഀ
--਍ഀ
਍ഀ
LOCK TABLES `passwordresettoken` WRITE;਍ഀ
/*!40000 ALTER TABLE `passwordresettoken` DISABLE KEYS */;਍ഀ
INSERT INTO `passwordresettoken` VALUES ('0a8f4f0a-19bc-11f1-97b2-6c02e0d26821','ba9e888a-18fc-11f1-97b2-6c02e0d26821','6a7fa43c3fabcfb5f124715628d126aacfeec302a273f26829fc7ed9b1d82736','2026-03-07 03:24:45','2026-03-07 02:24:44');਍ഀ
/*!40000 ALTER TABLE `passwordresettoken` ENABLE KEYS */;਍ഀ
UNLOCK TABLES;਍ഀ
਍ഀ
--਍ഀ
-- Table structure for table `role`਍ഀ
--਍ഀ
਍ഀ
DROP TABLE IF EXISTS `role`;਍ഀ
/*!40101 SET @saved_cs_client     = @@character_set_client */;਍ഀ
/*!50503 SET character_set_client = utf8mb4 */;਍ഀ
CREATE TABLE `role` (਍ഀ
  `id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,਍ഀ
  PRIMARY KEY (`id`),਍ഀ
...
਍ഀ
-- Dump completed on 2026-04-01  1:26:53਍ഀ
